...
through a resource-pack. The mod by default, comes with a built-in resource pack with supports many popular mods (see [[gallery]]).
...
For details on the supported areas that can be patched onto Euphoria Patches, check out this [tutorial](tutorials/getting_started).
...
**A:** All in due time. Alternatively, you could do it yourself. Have a look at this [tutorial](tutorials/getting_started) for more details.
